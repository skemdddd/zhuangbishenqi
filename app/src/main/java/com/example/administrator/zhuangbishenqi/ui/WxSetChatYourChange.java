 ...
 */
public class WxSetChatYourChange extends WxSetChatChange {
    Name name;
...
//                自定一名字
    ...
    private void setPicToView(Bitmap mBitmap) {
        ...
        file.mkdirs();// 创建文件夹
        String fileName =path + "yourHead.jpg";//图片名字
        try {
    ...
    public void setSaveName(TextView textView){
        ...
        SharedPreferences.Editor editor = getSharedPreferences("lockyour", 0x0002).edit();
        //步骤2-2：将获取过来的值放入文件
